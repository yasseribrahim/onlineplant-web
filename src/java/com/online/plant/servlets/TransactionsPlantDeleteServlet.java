 ...
 * @author user
 */
@WebServlet(name = "TransactionsPlantDelete", urlPatterns = "/transactions/plant/delete")
public class TransactionsPlantDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        client.deleteTransactionPlantDetails(id, plantId);
