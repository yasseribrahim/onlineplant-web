                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="seller-transaction-plants.jsp?id=<%=transaction.getId()%>" class="btn btn-primary">View Products</a>
                                        <a href="seller-transaction-plant-add.jsp?id=<%=transaction.getId()%>" class="btn btn-info">Add Products</a>
                                        <hr>
