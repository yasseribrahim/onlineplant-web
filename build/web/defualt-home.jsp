                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a href="login.html" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-danger">Sorry!!!, User not support</h6>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        Click here to <a href="login.html">Login &rarr;</a>
                                    </div>
                                </div>
                            </div>
                        </div>
