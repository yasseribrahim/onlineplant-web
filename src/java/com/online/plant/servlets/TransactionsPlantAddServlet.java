 ...
 * @author user
 */
@WebServlet(name = "TransactionPlantAdd", urlPatterns = "/transactions/plant/add")
public class TransactionsPlantAddServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        client.addTransactionPlantDetails(id, plantId, quantity);
