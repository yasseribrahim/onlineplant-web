                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <table class="table table-bordered" id="dataTable" width="100&percnt;" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-info" href="seller-transaction-plant-edit.jsp?id=<%=transaction.getId()%>&plantId=<%=details.getId()%>">Edit Plant</a></td>
                                                        <td><a class="btn btn-danger" href="transactions/plant/delete?id=<%=transaction.getId()%>&plantId=<%=details.getId()%>">Delete Plant</a></td>
                                                    </tr>
                                                    <%}%>
                                                </tbody>
                                            </table>
                                        ...
                                        <hr>
                                        Click here to <a href="seller-transaction-details.jsp?id=<%=transaction.getId()%>">Back &rarr;</a>
                                    </div>
                                </div>
                            </div>
                        </div>
